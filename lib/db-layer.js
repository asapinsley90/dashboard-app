...
async function updateUser(id, { name, passwordHash, onboardingStep, dashboardPrefs }) {
  const fields = [];
  const vals = [];
...
module.exports = { initDB, readDB, writeDB, close, DB_PATH, hasAnyUser, getUserByInstance, getUserById, createUser, updateUser, getTypeSchemas, saveTypeSchema, deleteTypeSchema, getUserTemplates, saveUserTemplate, deleteUserTemplate, submitPendingTemplate, getPendingTemplates, updatePendingTemplateStatus, getStats };
