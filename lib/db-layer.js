...
module.exports = { initDB, readDB, writeDB, close, DB_PATH, hasAnyUser, getUserByInstance, getUserById, createUser, updateUser, getUserByUsernameOrEmail, verifyEmailToken, setResetToken, getUserByResetToken, getTypeSchemas, saveTypeSchema, deleteTypeSchema, getUserTemplates, saveUserTemplate, deleteUserTemplate, submitPendingTemplate, getPendingTemplates, updatePendingTemplateStatus, getStats, createTenant, getTenants, updateTenantStatus, createWaitlistEntry, getWaitlist, getWaitlistEntry, updateWaitlistStatus };
