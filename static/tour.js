...
const TOUR_STEPS = [
  ...
  },
  {
    ...
    text: 'Events from all your areas appear here automatically — no need to add them twice. Head here to add your first one whenever you\'re ready.',
    advance: 'manual',
    cta: 'Got it',
    position: 'right',
  },
  {
    ...
    text: 'Contacts live here but link across all your areas — an interviewer on a job, a doctor on a health record, a vendor on a project. One contact, referenced everywhere.',
    advance: 'manual',
    cta: 'Got it',
    position: 'right',
  },
  {
    ...
    text: 'Any file you upload to a record also appears here — searchable and filterable across every area. No hunting through folders.',
    advance: 'manual',
    cta: 'Got it',
    position: 'right',
  },
  {
    ...
    text: 'The dashboard updates live as you add records. You can hide, reorder, or collapse any section — it\'s yours to configure.',
    advance: 'manual',
    cta: 'Let\'s go!',
    position: 'right',
